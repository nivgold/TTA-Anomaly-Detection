...
class CreditCardDataset:
    def __init__(self, data_dir_path, from_disk=False, disk_path='/home/nivgold/pkls/oversampling_pkls/creditcard_pkls'):
        ...
        if from_disk:
            ...
            # loading from files
            self.train_features = pd.read_pickle(disk_path+"/train_features_creditcard.pkl")
            self.train_labels = pd.read_pickle(disk_path+"/train_labels_creditcard.pkl")

            self.test_features = pd.read_pickle(disk_path+"/test_features_creditcard.pkl")
            self.test_labels = pd.read_pickle(disk_path+"/test_labels_creditcard.pkl")
    ...
    def preprocessing(self, data):
        ...
        def _agg_df(df):
            ...
            desired_cols = ['V1', 'V2', 'V3', 'V4', 'V5', 'V6', 'V7', 'V8', 'V9', 'V10',
