...
cardio_X, cardio_y, cardio_pairs = carmd.get_dataset(HOME_PATH, 32, from_disk=True)
...
solver_obj = Solver(X=cardio_X, y=cardio_y, n_folds=args.n_folds, dataset_name=dataset_name, epochs=EPOCHS, features_dim=CARDIO_DIM, siamese_data=cardio_pairs)
