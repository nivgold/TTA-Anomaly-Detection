...
import lympho_dataset_folded as lymd
...
lympho_X, lympho_y, lympho_pairs = lymd.get_dataset(HOME_PATH, 32, from_disk=True)
...
solver_obj = Solver(X=lympho_X, y=lympho_y, n_folds=args.n_folds, dataset_name=dataset_name, epochs=EPOCHS, features_dim=LYMPHO_DIM, siamese_data=lympho_pairs)
