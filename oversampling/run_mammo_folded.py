...
mammo_X, mammo_y, mammo_pairs = mammd.get_dataset(HOME_PATH, 32, from_disk=True)
...
solver_obj = Solver(X=mammo_X, y=mammo_y, n_folds=args.n_folds, dataset_name=dataset_name, epochs=EPOCHS, features_dim=MAMMO_DIM, siamese_data=mammo_pairs)
