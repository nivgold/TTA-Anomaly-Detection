...
import musk_dataset_folded as satmd
...
musk_X, musk_y, musk_pairs = satmd.get_dataset(HOME_PATH, 32, from_disk=True)
end_train_test = time.time()
print("--- Musk dataset ready after: ", end='')
get_execute_time(start_time, end_train_test)
dataset_name = 'musk'
weights_path = '/home/nivgold/models/oversampling_models'
solver_obj = Solver(X=musk_X, y=musk_y, n_folds=args.n_folds, dataset_name=dataset_name, epochs=EPOCHS, features_dim=MUSK_DIM, siamese_data=musk_pairs)
