...
satellite_X, satellite_y, satellite_pairs = sd.get_dataset(HOME_PATH, 32, from_disk=True)
...
solver_obj = Solver(X=satellite_X, y=satellite_y, n_folds=args.n_folds, dataset_name=dataset_name, epochs=EPOCHS, features_dim=SATELLITE_DIM, siamese_data=satellite_pairs)
