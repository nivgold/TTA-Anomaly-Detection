...
satimage_X, satimage_y, satimage_pairs = satmd.get_dataset(HOME_PATH, 32, from_disk=True)
...
solver_obj = Solver(X=satimage_X, y=satimage_y, n_folds=args.n_folds, dataset_name=dataset_name, epochs=EPOCHS, features_dim=SATIMAGE_DIM, siamese_data=satimage_pairs)
