...
import seismic_dataset_folded as satmd
...
seismic_X, seismic_y, seismic_pairs = satmd.get_dataset(HOME_PATH, 32, from_disk=True)
end_train_test = time.time()
print("--- Seismic dataset ready after: ", end='')
get_execute_time(start_time, end_train_test)
dataset_name = 'seismic'
weights_path = '/home/nivgold/models/oversampling_models'
solver_obj = Solver(X=seismic_X, y=seismic_y, n_folds=args.n_folds, dataset_name=dataset_name, epochs=EPOCHS, features_dim=SEISMIC_DIM, siamese_data=seismic_pairs)
