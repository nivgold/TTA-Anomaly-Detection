...
#         distance_vector = self.distance_layer(sample1_features, sample2_features)
        # if len(distance_vector.shape) == 1:
            # distance_vector = tf.expand_dims(distance_vector, axis=-1)
